...
4. [Say hello example using GET method](../examples/set6/say_hello.php) Examine to code and copy the given URL into your browser address. Try changing the value.
